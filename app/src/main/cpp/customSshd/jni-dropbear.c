...
#include "dropbear/src/dbutil.h"
#include "dropbear/src/dbrandom.h"
...
Java_com_hepta_guardx_Tool_Sshd_DropbearUtil_start_1sshd(
        JNIEnv *env,
        jobject thiz,
        jstring j_lib_path,
...
Java_com_hepta_guardx_Tool_Sshd_DropbearUtil_kill(
        JNIEnv *env,
        jobject thiz,
        jint pid) {
    kill(pid, SIGKILL);
...
Java_com_hepta_guardx_Tool_Sshd_DropbearUtil_waitpid(
        JNIEnv *env,
        jobject thiz,
        jint pid) {
    int status;
...
JNIEXPORT void JNICALL
Java_com_hepta_guardx_Tool_Sshd_DropbearUtil_mountTest(JNIEnv *env, jclass clazz) {
